...
public class MainActivity extends AppCompatActivity implements imageInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.images_frag);
        imageRecyclerView = findViewById(R.id.imageRecycle);
    ...
    private void setUpRecycleView(List<images_details> imagesDetailsList) {
        imgAdapt = new imageAdapt(this, imagesDetailsList, this);
    ...
    private void deleteItem(final int position) {
        ...
        snackbar.setAction(0, new View.OnClickListener() {
            @Override
